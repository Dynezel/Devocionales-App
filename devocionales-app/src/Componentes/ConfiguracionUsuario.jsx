        ...
        <form onSubmit={handleModificarPerfil}>
          ...
          <div className="profile-picture-container-configuracion" onClick={handleProfilePictureClick}>
            <img
              ...
              src={imagenPerfil ? URL.createObjectURL(imagenPerfil) : (user.fotoPerfil ? `http://localhost:8080/imagen/perfil/${user.idUsuario}` : "default-profile.png")} 
          ...
          <div className="banner-picture-container-configuracion" onClick={handleBannerClick}>
            <img
              ...
              src={banner ? URL.createObjectURL(banner) : (user.bannerPerfil ? `http://localhost:8080/imagen/perfil/banner/${user.idUsuario}` : bannerDefault)} 
